...
def runClassifier(args, options):
  ...
  if(options.data=="faces"):
    ...
    rawTestData = samples.loadDataFile("data/facedata/facedatatestn", numTest,FACE_DATUM_WIDTH,FACE_DATUM_HEIGHT)
    ...
    rawTestData = samples.loadDataFile("data/digitdata/testimagesn", numTest,DIGIT_DATUM_WIDTH,DIGIT_DATUM_HEIGHT)
  ...
  print >> f, "Time for training: ", elapsed_time, "seconds"
  print "Validating..."
  ...
  print >> f, str(correct), ("correct out of " + str(len(testLabels)) + " (%.1f%%).") % (100.0 * correct / len(testLabels))
