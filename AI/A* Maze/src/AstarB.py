...
class AstarB:
    def __init__(self, size, start, end, grid):
        ...
        self.grid = grid
        self.size = size
        self.origin = end # original target position
        self.start = start
        self.end = end # also current agent position
...
#         distinguish start and end positions
        ...
        self.grid[self.origin.x, self.origin.y] = 6
        print self.moves
