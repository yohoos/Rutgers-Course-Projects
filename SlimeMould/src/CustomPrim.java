...
public class CustomPrim {
     ...
     */
    public CustomPrim(EdgeWeightedGraph G, int s) {
        edgeTo = new Edge[G.V()];
...
//            if (!marked[v]) prim(G, v);      // minimum spanning forest
        ...
        //my addition for source, takes away forest finding capabilities
        prim(G, s);
    ...
    public static void main(String[] args) {
        ...
        CustomPrim mst = new CustomPrim(G, s);
